 ...
 */
@WebServlet("/cafe_insert.do")
public class CafeInsertActiion extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		//vo포장
		CafeVo vo = new CafeVo(c_name, c_addr, c_tel, c_price, c_park, c_time, c_hday, c_uri, c_map, c_photo, c_menu1, c_menu2, c_menu3, c_menu4, c_tag);
		
		//Dao
		int res = CafeDao.getInstance().insert(vo);
